...
///
/// IMPORTANT (requirement): these documents are DRAFT placeholders provided
/// so the system is structurally complete. They are NOT final legal text.
/// A qualified legal professional must review/replace every string below
/// before the funding feature is enabled for real money. Each document is
/// marked DRAFT and lists its jurisdiction and effective version so a future
/// update is a data change, not a code change.
library;
...
class LegalBundle {
  ...
  /// The default, clearly-marked-DRAFT bundle.
            ...
            sections: [
              ...
              LegalSection(
                ...
                'By tapping the payment button you confirm you have read these '
                    'terms (version 2026-09-01) and the privacy and refund '
                    'notices.',
              ),
            ],
          ),
